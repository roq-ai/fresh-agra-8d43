...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`fresh agra`}</title>

        <meta
          name="description"
          content="Experience the joy of delicious dining with Fresh Agra, your trusted online marketplace for the best food selections."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1504674900247-0877df9cc836?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmb29kfGVufDB8fHx8MTY5NDU0MTI0OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@lvnatikk?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Lily Banse`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the joy of delicious dining with Fresh Agra, your trusted online marketplace for the best food selections.`}
            </Text>
            <Box
