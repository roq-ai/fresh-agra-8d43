...
import { getSearchHistoryById } from 'apiSdk/search-histories';
import { SearchHistoryInterface } from 'interfaces/search-history';

function SearchHistoryViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('search_history', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/search-histories/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Search Term" text={data?.search_term} />
